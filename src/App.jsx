  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div>
          <div style={{ fontSize: 11, letterSpacing: 4, textTransform: "uppercase", opacity: 0.5, marginBottom: 4 }}>
            Live Observation
          </div>
          <h1 style={{ margin: 0, fontSize: "clamp(28px, 6vw, 48px)", fontWeight: 700, lineHeight: 1, letterSpacing: -1 }}>
            🐝 Wasp Watch
          </h1>
        </div>
